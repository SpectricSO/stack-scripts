...
(function() {
    $(document).ready(function() {
        ...
        $(".js-add-link.comments-link").on("click", function() {
            ...
            setTimeout(function() {
                const e = t.clone(),
                    o = n.parent().prev().find(".js-comment-text-input");
                e.insertBefore(o), $(".commentassist-option").on("click", function() {
                    const t = $(this).attr("data-type"),
                        ...
                        c = o.val(),
                        p = c.substring(0, i) + n + c.substring(i, a) + e + c.substring(a);
                    o.val(p), 0 == i ? (o.prop("selectionStart", c.length + n.length), o.prop("selectionEnd", c.length + n.length)) : (o.prop("selectionStart", i + n.length), o.prop("selectionEnd", a + n.length)), o.focus()
                })
            }, 50)
        })
    });
